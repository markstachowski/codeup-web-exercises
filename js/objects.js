...
//console.log(person.sayHello());
    ...
    //         console.log(shoppers.name + " spent $" + shoppers.amount + " and is greater than $200. $" + discountFixed + " applied for new total of $" + newTotal);
    //     } else {
    //         console.log(shoppers.name + " spent $" + shoppers.amount + " and not greater than $200. No discount is applied.");
    //     }
    // }
